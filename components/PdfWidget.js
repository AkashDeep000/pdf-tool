...
const response = await axios.post( 'https://310c-172-83-13-4.ngrok.io//upload',
...
textShadow: "0 0 2rem rgb(255,129,213)",
  }} download>Download Compressed PDF<span style={{color:"rgb(78,152,255)"}}>{pdfRes?.size ? ` (${pdfRes.size}KB)` : null}</span></a>
